#
# Module manifest for module 'KeepAlive'
#
...
Copyright = '(c) 2019 Russell Slater. All rights reserved.'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/russellds/KeepAlive/blob/master/LICENSE'
